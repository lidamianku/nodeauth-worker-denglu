const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/qr-utils-BAfkUFj9.js","assets/element-plus-Czv39GTz.js","assets/vue-core-Daban9YF.js","assets/element-plus-Dh61In7b.css"])))=>i.map(i=>d[i]);
import { _ as ae, __tla as __tla_0 } from "./pdf-utils-CN9T4xGo.js";
import { p as K, v as ce, b as re, __tla as __tla_1 } from "./vaultService-C69PJmjL.js";
import { l as L, d as he, e as ge, __tla as __tla_2 } from "./index-BDsebh3t.js";
import { a as le } from "./argon2-browser-BN0dg-qA.js";
import { l as pe, __tla as __tla_3 } from "./resourceRegistry-CTx2SWVU.js";
import { argon2id as ye } from "./hash-wasm-Dup_VHWH.js";
import { unzipSync as me } from "./compression-utils-CXh1ITwj.js";
import { a as we } from "./qr-utils-BAfkUFj9.js";
import { B as Ae, S as oe, a as _e, b as J, c as Se, d as be, M as Ee, F as ve, e as fe, f as xe, g as Te } from "./wa-sqlite-D0naBMh4.js";
import "./vue-core-Daban9YF.js";
import "./element-plus-Czv39GTz.js";
    ...
    const Pe = {
        decodePayload (i) {
            ...
            function e() {
                ...
                for(; t < i.length;){
                    const a = i[t++];
                    if (h |= (a & 127) << s, (a & 128) === 0) break;
                    s += 7;
                }
                return h;
            }
            for(; t < i.length;){
                const h = i[t++], s = h >> 3, a = h & 7;
                if (s === 1 && a === 2) {
                    const o = e(), y = t + o;
                    ...
                    for(; t < y;){
                        ...
                        if (l === 1 && r === 2) {
                            ...
                            let p = 0, u = 0, _ = "";
                            for(let S = 0; S < d.length; S++)for(u = u << 8 | d[S], p += 8; p >= 5;)_ += c[u >>> p - 5 & 31], p -= 5;
                            p > 0 && (_ += c[u << 5 - p & 31]), g = _, t += f;
                        } else if (l === 2 && r === 2) {
                            const f = e();
...
`).filter((l)=>l.trim());
            ...
            const t = this._splitCsvLine(n[0]).map((l)=>l.toLowerCase()), e = [], h = t.includes("login_totp"), s = t.includes("otpauth") && !t.includes("title"), a = t.includes("otpauth") && t.includes("title"), o = t.includes("totp") && t.includes("vault") && t.includes("createtime"), y = t.includes("otpurl") && t.includes("title") && t.includes("username"), g = t.includes("issuer") || t.includes("secret") || t.includes("name"), m = [
                "otpauth",
                "login_totp",
                "totp",
                "mfa",
            ...
            for(let l = 1; l < n.length; l++){
                ...
                if (t.forEach((d, c)=>{
                    ...
                    if (d) {
                        let c = null;
                        if (d.startsWith("otpauth://") || d.startsWith("steam://")) c = K(d);
                        else {
                            const p = x(d);
                            /^[A-Z2-7]+=*$/.test(p) && (c = {
                    ...
                    const d = t.find((p)=>m.includes(p)), c = d ? (f[d] || "").trim() : "";
                    if (c) if (c.toLowerCase().startsWith("otpauth://") || c.toLowerCase().startsWith("steam://")) {
                        ...
                        if (p) {
                            ...
                            p.service = f[u] || p.service, p.account = f[_] || p.account, e.push(p);
                        }
                    } else {
                        const p = x(c);
                        if (/^[A-Z2-7]+=*$/.test(p)) {
        ...
        return ue || (ue = 1, (function(i, n) {
            (function(t) {
                function h(l) {
                    ...
                    let f = 1779033703, d = 3144134277, c = 1013904242, p = 2773480762, u = 1359893119, _ = 2600822924, S = 528734635, b = 1541459225;
                    const I = new Uint32Array(64);
                    function P(V) {
                        let Q = 0, B = V.length;
                        for(; B >= 64;){
                            let M = f, W = d, z = c, j = p, T = u, k = _, F = S, q = b, H, U, Z, X, te;
                            ...
                            for(U = 0; U < 64; U++)X = (((T >>> 6 | T << 26) ^ (T >>> 11 | T << 21) ^ (T >>> 25 | T << 7)) + (T & k ^ ~T & F) | 0) + (q + (r[U] + I[U] | 0) | 0) | 0, te = ((M >>> 2 | M << 30) ^ (M >>> 13 | M << 19) ^ (M >>> 22 | M << 10)) + (M & W ^ M & z ^ W & z) | 0, q = F, F = k, k = T, T = j + X | 0, j = z, z = W, W = M, M = X + te | 0;
                            f = f + M | 0, d = d + W | 0, c = c + z | 0, p = p + j | 0, u = u + T | 0, _ = _ + k | 0, S = S + F | 0, b = b + q | 0, Q += 64, B -= 64;
                        }
                    }
                    P(l);
                    let N, R = l.length % 64, O = l.length / 536870912 | 0, C = l.length << 3, G = R < 56 ? 56 : 120, D = l.slice(l.length - R, l.length);
                    for(D.push(128), N = R + 1; N < G; N++)D.push(0);
                    return D.push(O >>> 24 & 255), D.push(O >>> 16 & 255), D.push(O >>> 8 & 255), D.push(O >>> 0 & 255), D.push(C >>> 24 & 255), D.push(C >>> 16 & 255), D.push(C >>> 8 & 255), D.push(C >>> 0 & 255), P(D), [
                        f >>> 24 & 255,
                        f >>> 16 & 255,
                        f >>> 8 & 255,
                        f >>> 0 & 255,
                ...
                function s(l, r, f) {
                    ...
                    for(; f >= 32;)S(), _ = _.concat(h(p.concat(h(c)))), f -= 32;
                    return f > 0 && (S(), _ = _.concat(h(p.concat(h(c))).slice(0, f))), _;
                }
                function a(l, r, f, d, c) {
                    let p;
                    for(m(l, (2 * f - 1) * 16, c, 0, 16), p = 0; p < 2 * f; p++)g(l, p * 16, c, 16), y(c, d), m(c, 0, l, r + p * 16, 16);
                    for(p = 0; p < f; p++)m(l, r + p * 2 * 16, l, p * 16, 16);
                    for(p = 0; p < f; p++)m(l, r + (p * 2 + 1) * 16, l, (p + f) * 16, 16);
                }
                function o(l, r) {
                    return l << r | l >>> 32 - r;
                }
                ...
                function x(l, r, f, d, c, p, u) {
                    if (f = A(f, "N"), d = A(d, "r"), c = A(c, "p"), p = A(p, "dkLen"), f === 0 || (f & f - 1) !== 0) throw new Error("N must be power of 2");
                    ...
                    for(let T = 0; T < S.length; T++){
                        const k = T * 4;
                        S[T] = (_[k + 3] & 255) << 24 | (_[k + 2] & 255) << 16 | (_[k + 1] & 255) << 8 | (_[k + 0] & 255) << 0;
                    }
                    const b = new Uint32Array(64 * d), I = new Uint32Array(32 * d * f), P = 32 * d, N = new Uint32Array(16), R = new Uint32Array(16), O = c * f * 2;
                    let C = 0, G = null, D = !1, V = 0, Q = 0, B, M;
                    const W = u ? parseInt(1e3 / d) : 4294967295, z = typeof setImmediate < "u" ? setImmediate : setTimeout, j = function() {
                        if (D) return u(new Error("cancelled"), C / O);
                        let T;
                        switch(V){
                            case 0:
                            ...
                            case 1:
                                T = f - B, T > W && (T = W);
                                for(let F = 0; F < T; F++)m(b, 0, I, (B + F) * P, P), a(b, P, d, N, R);
                                if (B += T, C += T, u) {
                                    const F = parseInt(1e3 * C / O);
                                    if (F !== G) {
                                        if (D = u(null, C / O), D) break;
                                        G = F;
                                    }
                                }
                                if (B < f) break;
                ...
                const E = {
                    scrypt: function(l, r, f, d, c, p, u) {
                        return new Promise(function(_, S) {
                            let b = 0;
                            u && u(0), x(l, r, f, d, c, p, function(I, P, N) {
                                if (I) S(I);
                    ...
                    syncScrypt: function(l, r, f, d, c, p) {
                        return new Uint8Array(x(l, r, f, d, c, p));
                    }
                };
                i.exports = E;
            })();
    ...
    const Le = {
        async decryptDatabase (i, n) {
            ...
            const e = i.db, h = i.header.params;
            let s = null;
            ...
            const o = Ie(e), y = Y(h.nonce), g = Y(h.tag), m = new Uint8Array(o.length + g.length);
        ...
        async parse (i, n) {
            ...
            try {
                const e = atob(t.salt), h = new Uint8Array(e.length);
                for(let d = 0; d < e.length; d++)h[d] = e.charCodeAt(d);
        ...
        async parse (i, n) {
            try {
                const t = await pe("openpgp"), e = t?.default || t, h = await e.readMessage({
                    armoredMessage: i
        ...
        async decryptAndParse (i, n) {
            ...
            if (!n) throw new Error("PASSWORD_REQUIRED");
            const e = ie(t.kdfParams.salt), h = ie(t.encryptionNonce), s = ie(t.encryptedData), { opsLimit: a, memLimit: o } = t.kdfParams, y = Math.floor(o / 1024);
            let g;
            try {
                g = await ye({
                    password: n,
            ...
            let m;
            try {
                const E = await Ue(), l = E.crypto_secretstream_xchacha20poly1305_init_pull(h, g), r = E.crypto_secretstream_xchacha20poly1305_pull(l, s);
...
`), x = [];
    ...
    function ie(i) {
        ...
        for(let h = 0; h < t.length; h++)e[h] = t.charCodeAt(h);
        return e;
    }
    let ne = null;
    async function Ue() {
        if (ne) return ne;
        const i = await pe("libsodium"), n = i?.default || i;
    ...
    class Ce extends Ae {
        ...
        xOpen(n, t, e, h) {
            ...
            return this.mapIdToFile.set(t, s), h.setInt32(0, e, !0), J;
        }
        xClose(n) {
        ...
        xRead(n, t, e) {
            const h = this.mapIdToFile.get(n), s = Math.min(e, h.size), o = Math.min(e + t.byteLength, h.size) - s;
            return o && t.set(new Uint8Array(h.data, s, o)), o < t.byteLength ? (t.fill(0, o), be) : J;
        }
        xWrite(n, t, e) {
            const h = this.mapIdToFile.get(n);
            if (e + t.byteLength > h.data.byteLength) {
                const s = Math.max(e + t.byteLength, 2 * h.data.byteLength), a = new ArrayBuffer(s);
                new Uint8Array(a).set(new Uint8Array(h.data, 0, h.size)), h.data = a;
            }
            return new Uint8Array(h.data, e, t.byteLength).set(t), h.size = Math.max(h.size, e + t.byteLength), J;
        }
        xTruncate(n, t) {
        ...
        xAccess(n, t, e) {
            const h = this.mapNameToFile.get(n);
            return e.setInt32(0, h ? 1 : 0, !0), J;
        }
    }
    class Me extends Ce {
        name = "memory-async";
        ...
        xOpen(n, t, e, h) {
            return this.handleAsync(async ()=>super.xOpen(n, t, e, h));
        }
        xClose(n) {
    ...
    qe = {
        detectFileType (i, n) {
            if (i instanceof ArrayBuffer || i instanceof Uint8Array) {
                const e = i instanceof Uint8Array ? i : new Uint8Array(i), h = "SQLite format 3";
                let s = !0;
                for(let a = 0; a < h.length && a < e.length; a++)if (e[a] !== h.charCodeAt(a)) {
                    s = !1;
                    break;
                }
...
`)[0].toLowerCase() : "";
        ...
        async exportData (i, n, t, e = "generic") {
            ...
            if (n === "2fas") {
                const a = i.map((o, y)=>{
                    const g = o.algorithm?.toUpperCase() === "STEAM", m = g ? "SHA1" : (o.algorithm || "SHA1").toUpperCase().replace("SHA-1", "SHA1").replace("SHA-256", "SHA256").replace("SHA-512", "SHA512");
                    return {
                        name: o.service,
                        secret: o.secret,
                        otp: {
                            source: "manual",
                            account: o.account || "",
                            digits: g ? 5 : o.digits || 6,
                            period: o.period || 30,
                            algorithm: m,
                            tokenType: g ? "STEAM" : "TOTP",
                            counter: 0
                        },
                        order: {
                            position: y
...
`;
                return i.forEach((o)=>{
                    const y = o.algorithm?.toUpperCase() === "STEAM", g = `"${o.service}${o.account ? ":" + o.account : ""}"`, m = y ? `steam://${o.secret}` : re({
                        service: o.service,
                        account: o.account,
                        secret: o.secret,
...
`;
            ...
            if (n === "bitwarden_auth_json") {
                const a = i.map((o)=>{
                    const g = o.algorithm?.toUpperCase() === "STEAM" ? `steam://${o.secret}` : re({
                        service: o.service,
                        account: o.account,
                        secret: o.secret,
                        algorithm: o.algorithm,
        ...
        async exportAsGaMigration (i) {
            ...
            const e = Math.floor(Math.random() * 2147483647), h = await ae(()=>import("./qr-utils-BAfkUFj9.js").then((g)=>g.b), __vite__mapDeps([0,1,2,3])), s = [];
            function a(g, m) {
            ...
            for(let g = 0; g < t.length; g++){
                ...
                for (const l of m){
                    ...
                    for(let I = 0; I < d.length; I++){
                        const P = f.indexOf(d[I]);
                        P !== -1 && (u = u << 5 | P, p += 5, p >= 8 && (c.push(u >>> p - 8 & 255), p -= 8));
                    }
                ...
                const x = `otpauth-migration://offline?data=${encodeURIComponent(btoa(A))}`, E = await h.toDataURL(x, {
        ...
        async exportAsHtml (i) {
            const n = await ae(()=>import("./qr-utils-BAfkUFj9.js").then((e)=>e.b), __vite__mapDeps([0,1,2,3])), t = [];
            t.push(`
      <!DOCTYPE html>
      <html>
      <head>
...
`);
        ...
        async decrypt2FasEncrypted (i, n) {
            try {
                ...
                const s = [
                    ...
                    e[1],
                    e.slice(2).join(":")
                ].map((c)=>Uint8Array.from(atob(c.replace(/\s+/g, "")), (p)=>p.charCodeAt(0))), a = (c)=>{
                    const p = c.reduce((S, b)=>S + b.length, 0), u = new Uint8Array(p);
                    let _ = 0;
                    for (const S of c)u.set(S, _), _ += S.length;
                    return u;
                };
                let o, y, g;
                const m = s.findIndex((c)=>c.length === $.IV_LEN);
                if (m !== -1 && (y = s.splice(m, 1)[0], s.length > 0)) {
                    let c = 0;
                    for(let p = 1; p < s.length; p++)s[p].length < s[c].length && (c = p);
                ...
                if (!o || !y || !g) {
                    ...
                    for (const u of p)if (!(!u.salt || !u.iv || !u.cipher) && u.iv.length === $.IV_LEN) try {
                        ...
                        if (u.cipher.length >= 16) {
                            const I = u.cipher.slice(u.cipher.length - 16), P = u.cipher.slice(0, u.cipher.length - 16), N = await crypto.subtle.decrypt({
                                name: "AES-GCM",
                                iv: u.iv
                            }, b, new Uint8Array([
                                ...P,
                            ...
                            JSON.parse(R), o = u.salt, y = u.iv, g = u.cipher, c = !0, L.debug("[decrypt2FasEncrypted] permutation succeeded with:", u.name);
                            break;
                        }
                    } catch  {}
                    !c && !o && (o = s[0], y = s[1], g = s[2], o.length !== $.SALT_LEN && y.length === $.SALT_LEN && ([o, y] = [
                        y,
                        o
                    ]), y.length !== $.IV_LEN && g.length === $.IV_LEN && ([y, g] = [
                        g,
                        y
                    ]));
                }
                if (L.debug("[decrypt2FasEncrypted] chosen mapping lengths salt,iv,cipher=", o?.length, y?.length, g?.length), o.length < 16) throw new v(`salt 长度过短：${o.length}`, "INVALID_SALT_LEN");
                ...
                if (L.debug("[decrypt2FasEncrypted] key derived"), g.length < 16) throw new v("密文过短（无法包含 auth tag）", "CIPHERTEXT_TOO_SHORT");
        ...
        async decryptBitwardenPassEncrypted (i, n) {
            try {
                const t = n.salt, e = n.kdfIterations, h = n.kdfType;
                if (h !== 0) throw new v(`不支持的 KDF 类型: ${h}`, "UNSUPPORTED_BITWARDEN_KDF");
                const s = new TextEncoder().encode(t), a = new TextEncoder().encode(i), o = await crypto.subtle.importKey("raw", a, {
                    ...
                    const c = d[1].split("|"), p = Uint8Array.from(atob(c[0]), (O)=>O.charCodeAt(0)), u = Uint8Array.from(atob(c[1]), (O)=>O.charCodeAt(0)), _ = Uint8Array.from(atob(c[2]), (O)=>O.charCodeAt(0)), S = await crypto.subtle.importKey("raw", f, {
                        name: "HMAC",
                        hash: "SHA-256"
                    }, !1, [
                        "sign"
                    ]), b = new Uint8Array(p.length + u.length);
                    b.set(p, 0), b.set(u, p.length);
        ...
        async _hkdfExpandSha256 (i, n, t) {
            const e = new TextEncoder().encode(n || ""), h = await crypto.subtle.importKey("raw", i, {
                name: "HMAC",
                hash: "SHA-256"
            }, !1, [
                "sign"
            ...
            for(; o < t;){
                ...
                g.set(a, 0), g.set(e, a.length), g[g.length - 1] = y & 255, a = new Uint8Array(await crypto.subtle.sign("HMAC", h, g));
        ...
        bytesToBase32 (i) {
            ...
            let t = 0, e = 0, h = "";
            for(let s = 0; s < i.length; s++)for(e = e << 8 | i[s], t += 8; t >= 5;)t -= 5, h += n[e >>> t & 31];
            for(t > 0 && (h += n[e << 5 - t & 31]); h.length % 8;)h += "=";
            return h;
        },
        base64ToBase32 (i) {
            try {
        ...
        async parsePhoneFactor (i) {
            ...
            let n = null, t = null, e = null, h = null;
            try {
                ...
                const a = ve(s);
                console.log("[PhoneFactor] sqlite3 Factory 完成"), h = new Me;
                const o = `vfs-${Date.now()}`;
                h.name = o, a.vfs_register(h), console.log("[PhoneFactor] VFS 注册完成:", o);
                const y = "PhoneFactor", g = (d, c)=>{
                    const p = c.buffer.slice(c.byteOffset, c.byteOffset + c.byteLength);
                    h.mapNameToFile.set(d, {
                        name: d,
                        flags: oe | fe | xe,
                        size: c.byteLength,
                        data: p
                ...
                L.info("[PhoneFactor] open_v2 成功"), L.info("[PhoneFactor] 执行 PRAGMA locking_mode..."), await a.exec(w, "PRAGMA locking_mode = EXCLUSIVE;"), L.info("[PhoneFactor] 执行 PRAGMA journal_mode..."), await a.exec(w, "PRAGMA journal_mode = DELETE;"), L.info("[PhoneFactor] PRAGMA 完成");
                let A = !1;
                if (await a.exec(w, "SELECT name FROM sqlite_master WHERE type='table' AND name='accounts'", (d)=>{
                    A = !0;
                }), L.info(`[PhoneFactor] accounts 表存在: ${A}`), !A) throw await a.close(w), new v("不是有效的Microsoft Authenticator数据文件", "INVALID_PHONEFACTOR_FILE");
                const x = [];
                let E = 0, l = 0, r = 0;
                const f = /^[A-Z2-7]+=*$/i;
                try {
                    ...
                    if (c && c.stmt) {
                        ...
                        try {
                            let u = 0;
                            for(; await a.step(p) === Te;){
                                u++, u % 5 === 0 && L.info(`[PhoneFactor] 已读取 ${u} 行...`);
                                const _ = a.row(p), S = _[0], b = _[1];
                                let I = _[2];
                                const P = _[3], N = _[4];
                                ...
                                try {
                                    ...
                                    L.warn(`Failed to convert secret for account_type=${N}: ${D.message}`), r++;
                                    continue;
                                }
                            ...
                            L.info(`[PhoneFactor] 行读取循环结束，总共提取 ${u} 行`);
                        } finally{
                            await a.finalize(p);
                        }
                    }
                    a.str_finish(d), L.info("[PhoneFactor] 数据提取完成，关闭 DB...");
                } catch (d) {
                    throw await a.close(w), new v("解析 PhoneFactor 数据库失败", "INVALID_PHONEFACTOR_FILE", d);
                }
                await a.close(w);
                try {
                    h.mapNameToFile.clear(), h.mapIdToFile.clear();
                } catch  {}
                ...
                if (s instanceof v) throw L.error("parsePhoneFactor migrationError:", s), s;
                try {
                    ...
                    L.error("parsePhoneFactor failed (logging error):", o);
                }
        ...
        async parseImportData (i, n, t) {
            ...
            if (i instanceof ArrayBuffer || i instanceof Uint8Array) try {
                ...
                L.warn("Failed to decode buffer as text", s);
            }
            if (i = h, (n === "bitwarden_auth_csv" || n === "1password_csv" || n === "generic_csv") && (e = de.parseCsv(i), i = JSON.stringify(e), n = "raw"), n === "proton_auth_encrypted") {
                if (!t) throw new v("导入 Proton Authenticator 备份需要密码", "MISSING_PASSWORD");
                e = await De.parse(i, t), n = "raw", i = JSON.stringify(e), t = void 0;
            }
            ...
            if (n === "aegis_encrypted") {
                const s = ee(i), a = await Le.decryptDatabase(s, t);
...
`).forEach((a)=>{
        ...
        async parseGaQrImageFile (i) {
            return new Promise((n, t)=>{
                const e = new Image, h = URL.createObjectURL(i);
                e.onload = ()=>{
                    ...
                    URL.revokeObjectURL(h), t(new v("图片读取失败，文件可能已损坏", "IMAGE_LOAD_FAILED"));
                }, e.src = h;
            });
        },
        async parse1Pux (i) {
            try {
                ...
                const h = new TextDecoder().decode(e), s = JSON.parse(h), a = [];
